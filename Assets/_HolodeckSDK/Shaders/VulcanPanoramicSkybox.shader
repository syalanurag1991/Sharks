Shader "Vulcan/Panoramic Skybox" {
	Properties{
...
#endif
				tc.x = lerp(tc.x, 1 - tc.x, step(_MainTex_ST.x, 0));
				tc.y = lerp(tc.y, 1 - tc.y, step(_MainTex_ST.y, 0));
	...
	CustomEditor "VulcanPanoramicShaderGUI"
	Fallback Off
}